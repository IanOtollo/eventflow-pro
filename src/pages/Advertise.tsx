  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#050505]">
      ...
      <main className="flex-1">
        {/* B2B Hero */}
        <section className="relative overflow-hidden py-32 px-6 sm:px-10">
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-7xl font-black leading-[0.85] tracking-tighter text-white uppercase sm:text-9xl mb-12">
                Elevate Your <span className="text-accent italic">Brand.</span>
              </h1>
              <p className="text-xl font-medium text-white/50 leading-relaxed max-w-2xl mb-16">
              ...
              <div className="flex flex-wrap gap-8">
                 <Button size="lg" className="h-24 rounded-2xl bg-white px-16 text-xs font-black uppercase tracking-[0.4em] text-black hover:bg-accent transition-all" asChild>
        ...
        <section className="py-40 px-6 sm:px-10 border-t border-white/5">
            ...
            <div className="grid gap-20 lg:grid-cols-3">
              {[
                ...
                <motion.div
                  ...
                  className="p-10 rounded-[3rem] border border-white/5 bg-white/[0.02] backdrop-blur-3xl hover:border-accent/30 transition-all group"
                >
        ...
        <section className="py-40 px-6 sm:px-10">
          <div className="container text-center">
            <h2 className="font-display text-5xl font-black tracking-tighter text-white uppercase sm:text-8xl mb-12">
            ...
            <div className="flex justify-center gap-12 flex-wrap">
               <div className="flex flex-col items-center gap-4">
                 ...
                 <a href="mailto:iombookings@gmail.com" className="text-2xl font-black text-white hover:text-accent transition-colors">iombookings@gmail.com</a>
               </div>
               <div className="flex flex-col items-center gap-4 border-l border-white/5 pl-12">
